...
@Singleton
@Path("/healthcheck")
public class VertexHealthcheckServlet extends PluginHealthcheck {

    private final VertexHealthcheck healthcheck;

    @Inject
    public VertexHealthcheckServlet(final VertexHealthcheck healthcheck) {
